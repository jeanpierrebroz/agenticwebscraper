...
export class FormatterAgent {
  ...
  public async runTask(context: string): Promise<string> {
    ...
    That you do not add any additional text or explanations, just the formatted text itself. You can infer the format from the context, but do not add any additional information or explanations. Do not make any assumptions about the format, just follow the user's specified format. Do not make any information up.`;
